  ...
  class RobotParameters : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (this->nominal_ee_pos_length >> (8 * 3)) & 0xFF;
      ...
      u_base_mass.real = this->base_mass;
      *(outbuffer + offset + 0) = (u_base_mass.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_base_mass.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_base_mass.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_base_mass.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_base_mass.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_base_mass.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_base_mass.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_base_mass.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->base_mass);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_base_mass.base = 0;
      u_base_mass.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_base_mass.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_base_mass.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_base_mass.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_base_mass.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_base_mass.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_base_mass.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_base_mass.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->base_mass = u_base_mass.real;
      offset += sizeof(this->base_mass);
     return offset;
    }
