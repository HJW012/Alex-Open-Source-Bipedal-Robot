                        ...
                        dynamixel_sdk_examples::GetPosition::Response &res)
{
  ...
  // dxl_comm_result = packetHandler->read4ByteTxRx(portHandler, (uint8_t)req.id, ADDR_TORQUE_ENABLE, (uint32_t*)&pos, &dxl_error);
  // ROS_INFO("getTroqueStatus : [ID:%d] -> [POSITION:%d]", req.id, pos);
...
int main(int argc, char **argv)
{
  ...
  packetHandler->write1ByteTxRx(portHandler, DXL1_ID, ADDR_OPERATION_MODE, 2, &dxl_error);
  packetHandler->write1ByteTxRx(portHandler, DXL2_ID, ADDR_OPERATION_MODE, 2, &dxl_error);
  ...
  packetHandler->write1ByteTxRx(portHandler, DXL1_ID, ADDR_LED, 1, &dxl_error);
  packetHandler->write1ByteTxRx(portHandler, DXL2_ID, ADDR_LED, 1, &dxl_error);
